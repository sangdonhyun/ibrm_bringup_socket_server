...
STARTUP NOMOUNT
CREATE CONTROLFILE REUSE DATABASE "CLONEDB1" NORESETLOGS  ARCHIVELOG
    MAXLOGFILES 16
    MAXLOGMEMBERS 3
    MAXDATAFILES 1500
    MAXINSTANCES 8
...
-- ALTER DATABASE REGISTER LOGFILE '/ZFS/CLONEDB1/ARCH_ORCL_11/arch_1_1_1066334792.arc';
...
STARTUP NOMOUNT
CREATE CONTROLFILE REUSE DATABASE "CLONEDB1" RESETLOGS  ARCHIVELOG
    MAXLOGFILES 16
    MAXLOGMEMBERS 3
    MAXDATAFILES 1500
    MAXINSTANCES 8
