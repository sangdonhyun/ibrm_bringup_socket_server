...
echo -n "Enter your choice ("L" or "R") : "
     read input
		...
		do
		echo "=========================================================================="
		echo "echo " List of Shared Local File systmes [ POOL: \${POOLNAME_${i}} ] [ PROJECT: \${DATA_PROJNAME} ]"" |sh
		echo ""
		 	ZFS1="\${ZFSDIR}/show_shared_fs.sh \${LOGINSTRING_${i}} \${POOLNAME_${i}} \${DATA_PROJNAME} "; echo ${ZFS1} |sh |grep -v " login:"
       		     i=$(( $i + 1 ))
		done
		echo "=========================================================================="
            else
