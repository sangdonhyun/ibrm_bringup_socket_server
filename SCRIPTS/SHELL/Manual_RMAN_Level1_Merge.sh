...
if [ "$RUN_USER" = "root" ]
 then
        echo "======================================================================================================= " >> $SHELL_LOG
        echo " *** Starting RMAN Level 1 + Merge Manual Backup                               [`date '+%F %H:%M:%S'`]  " >> $SHELL_LOG
...
if [ "$RSTAT" = "0" ]
 then
        ...
        echo " *** Error occured during RMAN Incremental Level 1 + Merge Backup 	     [ CODE : $RSTAT ]        " >> $SHELL_LOG
        echo "======================================================================================================= " >> $SHELL_LOG
  fi
 exit $RSTAT
