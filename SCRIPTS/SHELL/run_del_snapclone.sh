...
echo -n "Enter your choice ( "Local" or "Replicate" ) : "
     read input
          ...
          if [ "$input" = L ]
              then
                echo    "All of Clone Data in the Project [ ${DATA_PROJNAME} ] will be deleted. "
		echo -n "Please enter [y] to continue : "
			 ...
			 b=1
		   	    while [ $a -le $DSHARE_NO ]
		   	     do
        			ZFS="\${ZFSDIR}/del_clone.sh \${LOGINSTRING_${a}} \${POOLNAME_${a}} \${DATA_PROJNAME} \${SHARE_CLONE_DATA_${a}} " ; echo $ZFS | sh
        			a=$(( $a + 1 ))
		   	    ...
		   	    while [ $b -le $ARCH_NO ]
		   	     do
        			ZFS1="\${ZFSDIR}/del_clone.sh \${LOGINSTRING_${b}} \${POOLNAME_${b}} \${ARCH_PROJNAME} \${SHARE_CLONE_ARCH_${b}} " ; echo $ZFS1 | sh
        			b=$(( $b + 1 ))
		   	     done
                   else
